    ...
    <section className="flex flex-col md:flex-row items-center justify-center max-w-[1280px] mx-auto py-16 px-4 gap-6 md:gap-20">
      ...
      <div className="md:w-1/2 text-center order-2 md:order-1">
        <div className="max-w-fit ml-auto">
          ...
          <h2 className="text-5xl font-bold mt-2">Priyansh Yadav</h2>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6">
            <SocialIcons iconSrc={Github} url="https://github.com/priyanshyv" />
            <SocialIcons iconSrc={YoutubeIcon} url="https://youtube.com/@priyanshyv/" />
            <SocialIcons iconSrc={LinkedInIcon} url="https://linkedin.com/in/priyanshyv/" />
          </div>
        </div>
      </div>
